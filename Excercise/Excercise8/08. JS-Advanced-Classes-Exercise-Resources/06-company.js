class Company{
    ...
    addEmployee(name, salary, position, department) {
        ...
        let currentDepartment = this.department.find(d => d.name === department);
        if (!currentDepartment) {
            currentDepartment = { name: department, employees: [] };
            this.department.push(currentDepartment);
        }
    ...
    bestDepartment() {
        ...
        const bestDepartment = this.department.sort((a, b) => b.averageSalary - a.averageSalary)[0];
